import core.Problem2.DepthFirstSearch;
...
public class DepthFirstSearchTest {
  ...
  @Unit
  public void testDepthFirstSearch() throws Test.FailException {
...
//    Test.throwAssertQuiet("2-0, 2-3", dg.adjacent(2).equals(List.of(0, 3)));
...
//    Test.throwAssertQuiet("12-11, 12-13", dg.adjacent(12).equals(List.of(11, 13)));
    ...
    var dfs = new DepthFirstSearch(dg, 3);

    Test.throwAssertQuiet("3-4 Has Path", dfs.hasPathTo(4));
    Test.throwAssertQuiet("3-2 Has No Path (Directed)", !dfs.hasPathTo(2));
  }
}
