...
public class BreadthFirstSearch {
  ...
  @Unit
  public void testBreadthFirstSearch() throws Test.FailException {
...
//    Test.throwAssertQuiet("12-11, 12-13", dg.adjacent(12).equals(List.of(11, 13)));
    ...
    var bfs = new core.Problem2.BreadthFirstSearch(dg, 3);

    Test.throwAssertQuiet("3-4 Has Path", bfs.hasPathTo(4));
    Test.throwAssertQuiet("3-2 Has No Path (Directed)", !bfs.hasPathTo(2));
  }
}
